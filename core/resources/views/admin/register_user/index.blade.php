                        ...
                        <tr>
                          ...
                          <td>
                            @if (strpos($user->photo, 'facebook') !== false || strpos($user->photo, 'google'))
                                <img class="rounded-circle" src="{{$user->photo ? $user->photo : asset('assets/front/img/user/profile.jpg')}}" alt="user image" width="60">
                            @else
                                <img src="{{$user->photo ? asset('assets/front/img/user/'.$user->photo) : ''}}" alt="user image" width="60" class="rounded-circle">
                            @endif
                          </td>
                          <td>
                             {{$user->number}}
